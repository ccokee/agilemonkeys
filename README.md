...
## Build/Run
This is a spring boot application with Gradle as automation system
...
## Continuous  Deployment with Google Cloud Platform
This project is integrated with Cloud Build, https://cloud.google.com/cloud-build/
Every commit in the dev branch will trigger a new build of a docker image (based on the Dockerfile) and will save it in Google Cloud Container Registry.
